...
namespace Probel.Mvvm.DataBinding
{
    ...
    public static class ObservableCollectionFiller
    {
        ...
        {
            if (oCollection == null) throw new ArgumentNullException ("The base collection whereon insert new items is null.");
            if (collection == null) throw new ArgumentNullException ("The collection to insert into the base collection is empty.");
